...
export default function PostExtraOptions () {
  ...
  return (
    <div className="w-full text-right ">
      <Menu as="div" className="w-full relative inline-block text-left px-0">
        <div>
          <Menu.Button className="inline-flex bg-white lg:bg-none w-full justify-between space-x-1 items-center rounded-md box-border px-1 py-2 text-sm font-medium text-white">

            <AiOutlineMenu className='md:hidden w-4 h-4 text-black' />

              <div className='flex justify-between items-center space-x-1'>
                <BsThreeDots className='hidden md:inline-block w-4 h-4 text-black'/>
              </div>
          </Menu.Button>
        </div>
        <Transition
